...
const TrabajadoresPage = () => {
  ...
  const [sortKey, setSortKey] =
    useState<keyof Funcionario>("total_assignments");
  ...
  const columns: {
    header: string;
    accessor: keyof Funcionario;
    render?: (item: Funcionario) => React.ReactNode;
    sortable?: boolean;
    sortValue?: (
      item: Funcionario
    ...
    },
    {
      ...
      accessor: "dni",
      sortable: true,
      sortValue: (i) => Number(i.dni) || 0,
    },
    { header: "Teléfono", accessor: "phone" },
    {
      header: "Rango",
      accessor: "rol",
      render: (item: Funcionario) => item.rol.name,
    },
    {
      header: "Servicios",
      accessor: "total_assignments",
      render: (item: Funcionario) => item.total_assignments ?? 0,
      sortable: true,
      sortValue: (i) => i.total_assignments ?? 0,
    },
    {
  ...
  return (
    <>
      ...
      <Tooltip
        ...
        offset={10}
      />
      <Tooltip id="row-tooltip" place="bottom" variant="info" offset={5} />

      {/* Modal de crear nuevo funcionario */}
      <Modal
        isOpen={showForm}
      ...
      >
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            >
              <span>
                {newImage ? "Imagen seleccionada" : "Seleccionar imagen"}
              </span>
